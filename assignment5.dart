...
//Task1(1)
List <String> names= ['Hussain', 'Arsalan', 'Kazi', 'Iqbal', 'Shahzaib', 'Abdullah'];
print(names);
...
//Task3(3)
List<String> days2 = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
days2.removeLast();
print(days2);
days2.removeLast();
print(days2);
...
List<int>evenintegers = integers2.where((number) => number % 2 == 0).toList();
print(evenintegers);
